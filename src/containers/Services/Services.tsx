...
//       checkText: ['Проценты по вкладам до 7%', 'Разнообразные условия', 'Проценты по вкладам до 7%'],
//       bttnCaption: 'Узнать подробнее'
//     }
//   }, {
//   credit: {
...
//       checkText: ['Ипотечный кредит', 'Автокредит', 'Потребительский кредит'],
//       additionalInfo: 'Рассчитайте ежемесячный платеж /br и ставку по кредиту воспользовавшись нашим кредитным калькулятором'
//     }
//   }, {
//   insurance: {
//       caption: 'Страхование',
...
//       checkText: ['Мобильный банк, /br который всегда под рукой', 'Приложение Лига-проездной позволит /br вам оплачивать билеты по всему миру'],
//       bttnCaption: 'Узнать подробнее'
//     }
//   }
// ]
